...
<Row xs={2} md={3} className="g-4">
 <CardGroup>
  <Card>
    <Card.Img variant="top" src={this.props.movieResult.poster_path} />
    <Card.Body>
      <Card.Title style={{fontWeight: "bold",fontSize:'20px', fontFamily: "Times New Roman"}}>
        {this.props.movieResult.title}</Card.Title>
